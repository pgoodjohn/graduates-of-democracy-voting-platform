		...
		<div class="col-sm-8">
			<div class="panel panel-info">
				<div class="panel panel-heading text-center">
					<h3>Vice-President for Structural Reformation</h3>
				</div> <!--PANEL HEADER-->
				<form data-toggle="validator" role="form" method="POST" action="php/struct.php">
				<!-- DYNAMIC CANDIDATES CREATION -->
					<?php
						$query = "SELECT * FROM StructVicePresidency WHERE 1";
						$result = mysqli_query($con, $query);
						while($row = mysqli_fetch_array($result)){
							echo '<div class="form-group">';
							echo '<input type="radio" name="struct" id="' . $row['UserId'] . "\" value=\"" . $row['UserId'] . '" required>';
